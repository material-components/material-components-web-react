...
import {iconsMap, denseMap, rtlMap, requiredMap, disabledMap, helperTextMap, getHelperKeyText} from './attributesMap';
        ...
        return requiredMap.map((isRequired) => {
          return disabledMap.map((disabled) => {
            return helperTextMap.map((helperText, helperTextIndex) => {
              ...
              const helperTextKey = getHelperKeyText(helperText, isValidationTextField);
