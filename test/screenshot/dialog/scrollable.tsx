...
class Scrollable extends React.Component<{}, {isOpen: boolean; action: string;}> {
        ...
        <Dialog
          ...
          <DialogContent>
            <p className='mdc-typography--body1'>
              ...
              roof, which made one room; and this room contained a rusty
              looking cookstove, a cupboard for the dishes, a table, three or
              four chairs, and the beds. Uncle Henry and Aunt Em had a big bed
              in one corner, and Dorothy a little bed in another corner. There
              was no garret at all, and no cellar--except a small hole dug in
              the ground, called a cyclone cellar, where the family could go in
              case one of those great whirlwinds arose, mighty enough to crush
              any building in its path. It was reached by a trap door in the
              middle of the floor, from which a ladder led down into the small,
              dark hole.
            </p>
            <p className='mdc-typography--body1'>
              ...
              it. Even the grass was not green, for the sun had burned the tops
              of the long blades until they were the same gray color to be seen
            ...
            <p className='mdc-typography--body1'>
              ...
              twinkled merrily on either side of his funny, wee nose. Toto
