...
test('NativeSelect.props.setRippleCenter sets state.lineRippleCenter', () => {
  const wrapper = shallow<Select>(<Select label='my label' />);
  wrapper
    .children()
    .first()
...
test('renders NativeSelect for select', () => {
  const wrapper = shallow(<Select label='my label' />);
  assert.equal(wrapper.childAt(0).type(), BaseSelect);
});

test('renders FloatingLabel after NativeSelect', () => {
  const wrapper = shallow(<Select label='my label' />);
...
test('passes classNames to NativeSelect through props.nativeSelectClassName', () => {
...
test('#NativeSelect.onChange will update state.value', () => {
  const wrapper = shallow<Select>(<Select label='my label' />);
...
test('#NativeSelect.onChange will call this.props.onChange', () => {
...
test('#NativeSelect.handleDisabled will update state.disabled', () => {
  const wrapper = shallow<Select>(<Select label='my label' />);
  wrapper
    .childAt(0)
    .props()
...
test('passes foundation to NativeSelect', () => {
  const wrapper = mount<Select>(<Select label='my label' />);
  const nativeSelect = wrapper
    .childAt(0)
    .childAt(0)
    .props();
  assert.equal(nativeSelect.foundation, wrapper.state().foundation);
});
