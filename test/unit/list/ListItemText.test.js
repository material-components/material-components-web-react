...
// import {ListItemText} from '../../../packages/list';

// suite.only('ListItemText');
...
//   const wrapper = shallow(<ListItemText primaryText='Hello' secondaryText='World' />);
//   assert.isTrue(wrapper.hasClass('.mdc-list-item__text'));
...
//   const wrapper = shallow(<ListItemText primaryText={<span>Hello</span>} secondaryText={<span>World</span>} />);
//   assert.isTrue(wrapper.hasClass('.mdc-list-item__text'));
//   assert.exists(wrapper.find('.mdc-list-item__primary-text'));
//   assert.exists(wrapper.find('.mdc-list-item__secondary-text'));
// });
...
//   const wrapper = shallow(<ListItemText primaryText='Hello' tabIndex={3} tabbableOnListItemFocus/>);
//   assert.equal(wrapper.find('.mdc-list-item__text').props().tabIndex, 3);
// });

// test('has tabIndex of -1 if tabbableOnListItemFocus is false', () => {
//   const wrapper = shallow(<ListItemGraphic primaryText='Hello' childrenTabIndex={3}/>);
