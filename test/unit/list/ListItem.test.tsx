...
test('componentWillUnmount calls props.onDestroy()', () => {
  ...
  const wrapper = mount(<ListItem onDestroy={onDestroy}><div>Test</div></ListItem>);
  wrapper.unmount();
...
test('handleClick calls props.handleClick and props.onClick', () => {
  ...
  const wrapper = shallow(<ListItem onClick={onClick} handleClick={handleClick}><div>Test</div></ListItem>);
  const evt = {};
...
test('handleKeyDown calls props.handleKeyDown and props.onKeyDown', () => {
  ...
  const wrapper = shallow(<ListItem onKeyDown={onKeyDown} handleKeyDown={handleKeyDown}><div>Test</div></ListItem>);
  const evt = {};
...
test('handleFocus calls props.handleFocus and props.onFocus', () => {
  ...
  const wrapper = shallow(<ListItem onFocus={onFocus} handleFocus={handleFocus}><div>Test</div></ListItem>);
  const evt = {};
...
test('handleBlur calls props.handleBlur and props.onBlur', () => {
  ...
  const wrapper = shallow(<ListItem onBlur={onBlur} handleBlur={handleBlur}><div>Test</div></ListItem>);
  const evt = {};
